  ...
  subSections: [
    {
      ...
      techStack: {
        frontend:
          "Javascript, React, NextJS, MOBX, TypeScript, HTML5, SASS, Jest, Enzyme",
    ...
    },
    {
      ...
      techStack: {
        frontend:
          "Javascript, React, Redux, TypeScript, Styled Components, Jest, Enzyme",
    ...
    },
    {
      ...
      techStack: { frontend: "Angular 1.6, Javascript, Websockets, Node JS" },
    },
    {
      ...
      techStack: { frontend: "React, Redux, Micro-frontend Architecture" },
    },
    {
      ...
      techStack: {
        frontend:
          "Frontend: React, Redux, Tailwind, JavaScript, CSS , responsive design",
